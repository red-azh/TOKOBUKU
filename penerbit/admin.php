                            ...
                            ?>
                                <tbody>
                                    <tr>
                                        ...
                                        <td><?= $data["telepon"] ?></td>
                                        <td>
                                            <a href="edit.php?id=<?= $data["id"] ?>" style="text-decoration: none;"><button class="btn btn-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit">
                                                    <i class="fa fa-pen text-white"></i>
                                                </button>
                                            </a>
                                            <a href="delete.php?id=<?= $data["id"] ?>" style="text-decoration: none;"><button class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
