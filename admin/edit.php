...
<head>
    ...
    $queroy = "SELECT * FROM penerbit";
    $buku = mysqli_query($connect, $query);
    $penerbit = mysqli_query($connect, $queroy);
    $id = $_GET["id"];
    ...
    if (isset($_POST["simpan"])) { // Tombol simpan diklik
        ...
        $nama_buku = htmlspecialchars($_POST["nbuku"]);
        $harga = htmlspecialchars($_POST["harga"]);
        $stok = htmlspecialchars($_POST["stok"]);
        $penerbit = htmlspecialchars($_POST["penerbit"]);

        $query2 = "UPDATE buku SET kode='$kode', kategori='$kategori', nama_buku='$nama_buku', harga='$harga', stok='$stok', penerbit='$penerbit' WHERE id=$id";
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" value="<?= $data['kategori'] ?>" class="form-control" name="kategori" id="">
                                                </div>
                                                <div class="mb-3">
                                                    <label for="" class="form-label">Nama Buku</label>
                                                    <input type="text" value="<?= $data['nama_buku'] ?>" name="nbuku" class="form-control" id="">
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" value="<?= $data['stok'] ?>" name="stok" class="form-control" id="">
                                                </div>
