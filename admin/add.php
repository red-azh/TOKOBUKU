...
<head>
    ...
    if (isset($_POST["simpan"])) { // Tombol simpan diklik
        ...
        $query2 = "INSERT INTO buku (kode, kategori , nama_buku , harga, stok, penerbit) VALUES (' $kode', '$kategori' , '$nama_buku', $harga, $stok, '$penerbit' )";
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="nbuku" class="form-control" id="">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="mb-3">
